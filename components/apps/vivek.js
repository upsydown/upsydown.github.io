    ...
    return (
        <div className="flex flex-col items-center py-8 px-4">
            ...
            <ul className="text-sm text-gray-700 mb-6 space-y-1 text-left">
                ...
                <li><strong>CV :</strong> <a className="text-blue-600 underline" href="https://github.com/upsydown" target="_blank" rel="noopener">Consulter le CV (Profil GitHub)</a></li>
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="https://github.com/upsydown" title="Profil GitHub" frameBorder="0"></iframe>
    )
}