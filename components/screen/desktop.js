...
export class Desktop extends Component {
    ...
    render() {
        return (
            <div className={"h-full w-full bg-transparent relative overflow-hidden window-parent"}>
                ...
                {/* Desktop Apps (anchored so opening windows won't push them) */}
                <div className="absolute right-6 top-20 flex flex-col gap-1 z-10 items-end">
